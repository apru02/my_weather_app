...
export default function Forecast(props) {
  ...
  const [Precipitation_3, setPrecipitation3] = useState(45);
  fetch(url)
    ...
    .then((data) => {
      ...
      setPrecipitation3(day3.day.daily_chance_of_rain);
    })
    .catch((error) => {
      ...
      <div className="card-body">
        <table>
          ...
          <tr>
            ...
            <td>
              <img src={image3} alt="" className="for_image" />
            </td>
          </tr>
          <tr className="my_status">
            ...
            <td className="my_status">{status_3}</td>
          </tr>
          <tr>
